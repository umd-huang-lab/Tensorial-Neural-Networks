...
def main():
    ...
    data_loader = dataloader.Motion_DataLoader(
                        ...
                        num_workers=8,
                        path='./UCF101/preprocess/tvl1_flow/',
                        ucf_list='./UCF_list/',
                        ucf_split='01',
                        in_channel=10,
                        )
...
class Motion_CNN():
    def __init__(self, nb_epochs, lr, batch_size, resume, start_epoch, evaluate, train_loader, test_loader, channel,test_video, decompose_type, cr, name):
    ...
    def build_model(self):
        ...
        #build model
        self.model = resnet101(self.decompose_type, self.cr, pretrained=True, channel=self.channel).cuda()
        #print self.model
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            if is_best:
                ...
                with open('record/motion/' + self.name + '/motion_video_preds.pickle','wb') as f:
            ...
            },is_best,'record/motion/' + self.name + '/checkpoint.pth.tar','record/motion/' + self.name + '/model_best.pth.tar')
    ...
    def train_1epoch(self):
        ...
        record_info(info, 'record/motion/' + self.name + '/opf_train.csv','train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, 'record/motion/' + self.name + '/opf_test.csv','test')
