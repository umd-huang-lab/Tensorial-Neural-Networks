...
class RCP_Original(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, order, rank=None, cr=None,
        ...
        """
            ...
            """
        super(RCP_Original, self).__init__()
        ...
        self.conv2d1 = lambda inputs, weights, bias: \
    ...
    def forward(self, inputs):
        ...
        weights = conv_einsum(self.equation,self.kernels[0], self.kernels[1], self.kernels[2])
